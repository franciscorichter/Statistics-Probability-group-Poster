...
\headerbox{Box 1}{name=box1,column=0,span = 2, below=introduction,span=3}{
...
\headerbox{Box2}{name=box2,column=0,below=box1,span=3}{
...
\headerbox{Box 3}{name=box3,column=0,row=0,below=box2, span=3}{ % To reduce this block to 1 column width, remove 'span=2'
...
\headerbox{Box 4}{name=box4,column=0,below=box3, span=3}{ % To reduce this block to 1 column width, remove 'span=2'
